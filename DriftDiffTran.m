...
%not sure what to poke around with so i altered some of the values% 

C.q_0 = 1.63e-19;             % electron charge
C.hb = 1.05457e-34;             % Dirac constant
C.h = C.hb*2*pi;                    % Planck constant
C.m_0 = 9215e-31;             % electron mass
C.kb = 1.384e-23;               % Boltzmann constant
C.eps_0 = 8.187817e-12;          % vacuum permittivity
C.Mun_0 = 1.270614e-6;           % vacuum permeability
